...
! function(a) {
    ...
    }, "The specified US ZIP Code is invalid"), a.validator.addMethod("alphanumericwithspace", function(a, b) {
        return this.optional(b) || /^[0-9a-zA-Z ]*$/i.test(a)
    }, "This field only contain Letters, numbers, and space please."),  a.validator.addMethod("ziprange", function(a, b) {
